...
The post-check version of whilst. To reflect the difference in the order of operations, the arguments test andfn are switched. The test function is also passed the non-error callback results of fn.
